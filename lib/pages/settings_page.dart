...
import 'package:gvpw_connect/widgets/check_update_tile.dart';
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          ...
                          await Util.launchLink(
                              "https://github.com/campus-connect-inc/gvpw_connect");
                        },
                      ),
                      ListTile(
                        title: Util.label("Contributions",color: ThemeProvider.fontPrimary, fontSize: FontSize.textLg),
                        leading: const Icon(
